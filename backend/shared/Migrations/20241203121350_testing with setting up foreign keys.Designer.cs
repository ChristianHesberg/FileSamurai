...
namespace shared.Migrations
{
    ...
    [Migration("20241203121350_testing with setting up foreign keys")]
    partial class testingwithsettingupforeignkeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("core.models.UserFileAccess", b =>
                {
                    b.HasOne("core.models.File", null)
                        .WithOne()
                        .HasForeignKey("core.models.UserFileAccess", "FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("core.models.User", null)
                        .WithOne()
                        .HasForeignKey("core.models.UserFileAccess", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("core.models.UserRsaKeyPair", b =>
                {
                    b.HasOne("core.models.User", null)
                        .WithOne()
                        .HasForeignKey("core.models.UserRsaKeyPair", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
